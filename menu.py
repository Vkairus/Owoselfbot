...
class UI:
	...
	def logo(cls):
		...
		print(f"                   {color.purple}Version: PHUNLE-{version} moded VIP{color.reset}")
		time.sleep(0.5)
		print()
		print("╔═════════════════════════════════════════════════════════════════════════════════╗")
		print()
		print(f" {color.yellow}This is the moded auto by {color.okcyan}Iris {color.yellow}({color.okcyan}Vkairus{color.yellow}). {color.reset}")
	...
	def info(cls):
		...
		print(" ")
		print("Credit to this selfbot owner:vkairus")
		time.sleep(0.5)
